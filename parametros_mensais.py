...
class Parametros:
    ...
    def cliente_centro_produto(self):
        self.client = {
            ...
            725: {'PB.620': [1100], 'PB.658': [1100, 1101, 1160], 'PB.6DH': [1160]},  # Tabocão
            10174: {'PB.658': [1560, 9848], 'PB.6DH': [1560, 9848], 'PB.620': [1560, 9848]},  # Tabocão
            16906: {'PB.620': [1120], 'PB.658': [1120], 'PB.6DH': [1120]},  # Tabocão
            # 20347: {'PB.620': [1100], 'PB.658': [1100]},  # Distribuidora...
            # 17644: {'PB.620': [1101], 'PB.658': [1101]},  # Torrão
            # 4168: {'PB.620': [1111], 'PB.658': [1111]},  #
            # 21254: {'PB.620': [1120]},  # Rumos
            # 8425: {'PB.620': [1150]},
            # 15630: {'PB.620': [1150], 'PB.658': [1150], 'PB.6DH': [1150]}, # Torrao
            # 766: {'PB.620': [1160]}, # Aster (760)
            766: {'PB.658': [1160], 'PB.6DH': [1160]},  # Aster (760)
            # 21933: {'PB.620': [1160, 1150]},   # Rumos
            # 8944: {'PB.620': [1160], 'PB.658': [1160], 'PB.6DH': [1160]},  # Torrao
            # 17984: {'PB.620': [1250], 'PB.658': [1250], 'PB.6DH': [1250]}, # Torrao
            # 16350: {'PB.620': [1360, 9044], 'PB.658': [1360, 9044], 'PB.6DH': [1360]},
            1123: {'PB.620': [1500, 1507],'PB.658': [1500, 1507], 'PB.6DH': [1500, 1507], 'PB.650': [1500]},  # Sabba
            1125: {'PB.620': [1502, 9102],'PB.658': [1502, 9102], 'PB.6DH': [1502, 9102], 'PB.650': [1502]},  # Sabba
            ...
            17142: {'PB.620': [1700], 'PB.658': [1700], 'PB.6DH': [1700]},  # Sul combustivel
            665: {'PB.620': [1100, 1160]},  # Small
            7870: {'PB.620': [1400]},  # Small
    ...
    def cliente_matriz_z(self):
        self.cliente_matriz = {'PB.620': [724, 1122, 154, 655, 6814, 6997],
                               'PB.650': [1122, 154, 4432],
                               'PB.658': [760, 724, 1122, 6997],
                               'PB.6DH': [760, 724, 1122, 6997]}
