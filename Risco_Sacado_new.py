...
class Risco:
    ...
    def distri_cliente_polo_produto(self):
        self.distribuidoras = {Al: {8187: {1700: ['PB.620', 'PB.6DH', 'PB.658']}},Al: {1740: {1400: ['PB.620', 'PB.6DH', 'PB.658']}}},
    ...
    def abrir_plan_risco_sacado(self):
        ...
        for linha_plan in range(2, 3):
            for self.lista_distr()[0],info_1 in self.distri_cliente_polo_produto():
                for fili, info in info_1.items():
