...
class Risco:
    ...
    def salvar_arq(self):
        self.wb.save('risco_sacado(' + (assists.data_save_arquivo()) + ').xlsx')
        self.wb_cpgt.save('Cadastro_em_lote(' + assists.data_save_arquivo() + ').xlsx')
    ...
    def distri_cliente_polo_produto(self):
        Al = {8187: {1700: ['PB.620', 'PB.6DH', 'PB.658']}, 1740: {1400: ['PB.620', 'PB.6DH', 'PB.658']},
              4473: {1200: ['PB.620', 'PB.6DH', 'PB.658']}, 21699: {1100: ['PB.620', 'PB.6DH', 'PB.658']},
              4919: {1360: ['PB.6DH'], 1950: ['PB.6DH']}, 8429: {1101: ['PB.620', 'PB.6DH', 'PB.658']},
              1733: {1110: ['PB.620', 'PB.6DH', 'PB.658']}, 1732: {1111: ['PB.620', 'PB.6DH', 'PB.658']},
              1736: {1120: ['PB.620', 'PB.6DH', 'PB.658']}, 6833: {1130: ['PB.620', 'PB.6DH', 'PB.658']}}
        Cia = {455: {1400: ['PB.620', 'PB.6DH', 'PB.658']}, 18314: {1700: ['PB.620', 'PB.6DH', 'PB.658']},
               4150: {1100: ['PB.620', 'PB.6DH', 'PB.658']}}
        Ipp = {47: {1700: ['PB.620', 'PB.6DH', 'PB.658']}, 2093: {1400: ['PB.620', 'PB.6DH', 'PB.658']},}
        Mim = {17621: {1700: ['PB.620', 'PB.6DH', 'PB.658']}}
        Pet = {5142: {1360: ['PB.6DH'], 1950: ['PB.6DH']}}
        Rod = {7008: {1700: ['PB.620', 'PB.6DH', 'PB.658']}, 6815: {1400: ['PB.620', 'PB.6DH', 'PB.658']}}
        Rai = {49: {1700: ['PB.620', 'PB.6DH', 'PB.658']}, 2163: {1400: ['PB.620', 'PB.6DH', 'PB.658']},
               2153: {1200: ['PB.620', 'PB.6DH', 'PB.658'], 1210: ['PB.620', 'PB.6DH']},
               2150: {1100: ['PB.620', 'PB.6DH', 'PB.658']}, 2180: {1360: ['PB.6DH'], 1950: ['PB.6DH']},
               2155: {1101: ['PB.620', 'PB.6DH', 'PB.658']}, 18449: {1110: ['PB.620', 'PB.6DH', 'PB.658']},
               2186: {1111: ['PB.620', 'PB.6DH', 'PB.658']}, 2168: {1120: ['PB.620', 'PB.6DH', 'PB.658']},
    ...
    def abrir_plan_risco_sacado(self):
        ...
        for linha_plan in range(2, 3):
            for empresa in self.distri_cliente_polo_produto():
                for fili, info in empresa.items():
                    for centro, prod in info.items():
                        aba_act.cell(row=linha_plan, column=2).value = empresa
                        ...
                        aba_act.cell(row=linha_plan, column=7).value = prod
